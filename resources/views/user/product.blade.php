								...
								<div class="tab-content">
									...
									@foreach ($product->images as $image)
                                        <div id="di_tab_{{ $loop->index + 1 }}" class="tab-pane">
                                            <div class="image_wrap">
                                                <img src="{{asset('images/products/' . $product->id . '/' . $image->path)}}" alt="image_not_found">
                                            </div>
                                        </div>
                                    @endforeach
								</div>
						...
						<div class="col-lg-7">
							<div class="details_content">
								...
								<div class="action_btns d-flex align-items-center mb_15 clearfix">
									<a href="#!"><span><i class="far fa-heart"></i></span> Ajouter à la liste de souhaits</a>
								</div>
                                <div class="ul_li_block mb_15 clearfix">
                                    {!! html_entity_decode($product->brief_description) !!}
                                </div>

								<span class="item_price mb_15 d-flex align-items-center"><strong>{{ $product->price }} DHS</strong> <del>{{ $product->old_price }} DHS</del></span>
                                ...
                                <div class="item col">
                                    <div class="electronic_product_item">
                                        ...
                                        <div class="item_image">
                                            <img src="{{asset('images/products/' . $prod->id . '/' . $prod->image)}}" alt="image_not_found">
                                        </div>
