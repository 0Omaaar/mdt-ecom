                                        ...
                                        <div class="item">
                                            <div class="electronic_deals_item">
                                                ...
                                                <h3 class="item_title mb-0">
                                                    <a
                                                        href="{{ route('product', $dayDeal->id) }}">{{ $dayDeal->name }}</a>
                                                </h3>
    ...
    <section class="product_section mb_50 clearfix">
        <div class="container-fluid p-0">
            <div class="row no-gutters">
                ...
                <div class="col-lg-3">
                    <div class="alldepartments_dropdown audiovisual_entertainment d-block"
                        data-background="{{ asset('assets/user/images/backgrounds/bg_11.jpg') }}">
                        ...
                        <ul class="alldepartments_menulist ul_li_block clearfix">
                            <li class="has_child">
                                <a href="#!">
                                    <span class="icon">
                                        <img src="{{ asset('assets/user/images/icons/electronic/icon_01.png') }}"
                                            alt="icon_not_found">
                                    </span>
                                    Desktop PCs
                                </a>
                            ...
                            <li class="has_child">
                                <a href="#!">
                                    <span class="icon">
                                        <img src="{{ asset('assets/user/images/icons/electronic/icon_02.png') }}"
                                            alt="icon_not_found">
                                    </span>
                                    Ultrabooks
                                </a>
                            ...
                            <li class="has_child">
                                <a href="#!">
                                    <span class="icon">
                                        <img src="{{ asset('assets/user/images/icons/electronic/icon_03.png') }}"
                                            alt="icon_not_found">
                                    </span>
                                    Smartphones
                                </a>
                            ...
                            <li class="has_child">
                                <a href="#!">
                                    <span class="icon">
                                        <img src="{{ asset('assets/user/images/icons/electronic/icon_04.png') }}"
                                            alt="icon_not_found">
                                    </span>
                                    Internet Cams
                                </a>
                            ...
                            <li class="has_child">
                                <a href="#!">
                                    <span class="icon">
                                        <img src="{{ asset('assets/user/images/icons/electronic/icon_05.png') }}"
                                            alt="icon_not_found">
                                    </span>
                                    Accesories
                                </a>
                    ...
                    <div class="electronic_content_container">
                        <ul class="electronic_product_columns ul_li has_3columns mb_50 clearfix">
                            <li>
                                <div class="electronic_product_listlayout">
                                    <div class="item_image" data-bg-color="#f8f8f8">
                                        <img src="{{ asset('assets/user/images/shop/electronic/img_18.png') }}"
                                            alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                        <div class="item_price">
                            ...
                            <li>
                                <div class="electronic_product_listlayout">
                                    <div class="item_image" data-bg-color="#f8f8f8">
                                        <img src="{{ asset('assets/user/images/shop/electronic/img_19.png') }}"
                                            alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                        <div class="item_price">
                            ...
                            <li>
                                <div class="electronic_product_listlayout">
                                    <div class="item_image" data-bg-color="#f8f8f8">
                                        <img src="{{ asset('assets/user/images/shop/electronic/img_20.png') }}"
                                            alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                        <div class="item_price">
                            ...
                            <li>
                                <div class="electronic_product_listlayout">
                                    <div class="item_image" data-bg-color="#f8f8f8">
                                        <img src="{{ asset('assets/user/images/shop/electronic/img_21.png') }}"
                                            alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                        <div class="item_price">
                            ...
                            <li>
                                <div class="electronic_product_listlayout">
                                    <div class="item_image" data-bg-color="#f8f8f8">
                                        <img src="{{ asset('assets/user/images/shop/electronic/img_22.png') }}"
                                            alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                        <div class="item_price">
                            ...
                            <li>
                                <div class="electronic_product_listlayout">
                                    <div class="item_image" data-bg-color="#f8f8f8">
                                        <img src="{{ asset('assets/user/images/shop/electronic/img_24.png') }}"
                                            alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                        <div class="item_price">
                            ...
                            <li>
                                <div class="electronic_product_listlayout">
                                    <div class="item_image" data-bg-color="#f8f8f8">
                                        <img src="{{ asset('assets/user/images/shop/electronic/img_25.png') }}"
                                            alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                        <div class="item_price">
                            ...
                            <li>
                                <div class="electronic_product_listlayout">
                                    <div class="item_image" data-bg-color="#f8f8f8">
                                        <img src="{{ asset('assets/user/images/shop/electronic/img_26.png') }}"
                                            alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                        <div class="item_price">
                        ...
                        <div class="abtn_wrap text-center clearfix">
                            <a href="{{ route('products') }}" class="custom_btn btn_border border_electronic">Browse
                                Now</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-5">
                        <h2 class="title_text mb-0 text-white" data-bg-color="#201d1d">
                            <span class="text-white" data-bg-color="#3d3b3b"><i class="fal fa-plug"></i></span>
                            <strong>Daily deals!</strong> Get best prices.
                        </h2>
                    </div>
                        ...
                        <div class="row justify-content-lg-between">
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab1_1_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_32.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab1_1_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_06.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab1_1_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_03.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                                            ...
                                            <li>
                                                <a class="active" data-toggle="tab" href="#child_tab1_1_1">
                                                    <img src="{{ asset('assets/user/images/shop/electronic/img_32.png') }}"
                                                        alt="image_not_found">
                                                </a>
                                            </li>
                                            <li>
                                                <a data-toggle="tab" href="#child_tab1_1_2">
                                                    <img src="{{ asset('assets/user/images/shop/electronic/img_06.png') }}"
                                                        alt="image_not_found">
                                                </a>
                                            </li>
                                            <li>
                                                <a data-toggle="tab" href="#child_tab1_1_3">
                                                    <img src="{{ asset('assets/user/images/shop/electronic/img_03.png') }}"
                                                        alt="image_not_found">
                                                </a>
                                            </li>
                                        </ul>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab1_2_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_33.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab1_2_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_27.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab1_2_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_28.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                                            role="tablist">
                                            <li>
                                                <a class="active" data-toggle="tab" href="#child_tab1_2_1">
                                                    <img src="{{ asset('assets/user/images/shop/electronic/img_33.png') }}"
                                                        alt="image_not_found">
                                                </a>
                                            </li>
                                            <li>
                                                <a data-toggle="tab" href="#child_tab1_2_2">
                                                    <img src="{{ asset('assets/user/images/shop/electronic/img_27.png') }}"
                                                        alt="image_not_found">
                                                </a>
                                            </li>
                                            <li>
                                                <a data-toggle="tab" href="#child_tab1_2_3">
                                                    <img src="{{ asset('assets/user/images/shop/electronic/img_28.png') }}"
                                                        alt="image_not_found">
                                                </a>
                                            </li>
                                        </ul>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab1_3_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_34.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab1_3_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_15.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab1_3_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_30.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                                            role="tablist">
                                            <li>
                                                <a class="active" data-toggle="tab" href="#child_tab1_3_1">
                                                    <img src="{{ asset('assets/user/images/shop/electronic/img_34.png') }}"
                                                        alt="image_not_found">
                                                </a>
                                            </li>
                                            <li>
                                                <a data-toggle="tab" href="#child_tab1_3_2">
                                                    <img src="{{ asset('assets/user/images/shop/electronic/img_15.png') }}"
                                                        alt="image_not_found">
                                                </a>
                                            </li>
                                            <li>
                                                <a data-toggle="tab" href="#child_tab1_3_3">
                                                    <img src="{{ asset('assets/user/images/shop/electronic/img_30.png') }}"
                                                        alt="image_not_found">
                                                </a>
                                            </li>
                                        </ul>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab1_4_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_35.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab1_4_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_06.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab1_4_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_14.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                                            role="tablist">
                                            <li>
                                                <a class="active" data-toggle="tab" href="#child_tab1_4_1">
                                                    <img src="{{ asset('assets/user/images/shop/electronic/img_35.png') }}"
                                                        alt="image_not_found">
                                                </a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a data-toggle="tab" href="#child_tab1_4_3">
                                                    <img src="{{ asset('assets/user/images/shop/electronic/img_14.png') }}"
                                                        alt="image_not_found">
                                                </a>
                                            </li>
                                        </ul>
                        ...
                        <div class="row justify-content-lg-between">
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab2_1_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_32.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab2_1_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_06.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab2_1_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_03.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab2_2_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_33.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab2_2_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_27.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab2_2_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_28.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab2_3_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_34.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab2_3_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_15.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab2_3_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_30.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab2_4_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_35.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab2_4_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_06.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab2_4_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_14.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                        ...
                        <div class="row justify-content-lg-between">
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab3_1_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_32.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab3_1_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_06.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab3_1_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_03.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab3_2_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_33.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab3_2_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_27.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab3_2_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_28.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                                    ...
                                    <div class="item_content">
                                        ...
                                        <div class="progress_wrap clearfix">
                                            <div class="progress">
                                                <div class="progress_bar wow Rx_width_20 animated"
                                                    role="progressbar" data-wow-duration="0.5s"
                                                    data-wow-delay=".1s" aria-valuenow="0" aria-valuemin="0"
                                                    aria-valuemax="100">
                                                </div>
                                            </div>
                                            <span class="value_text">796 Sold</span>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab3_3_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_34.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab3_3_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_15.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab3_3_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_30.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab3_4_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_35.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab3_4_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_06.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab3_4_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_14.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                        ...
                        <div class="row justify-content-lg-between">
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab4_1_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_32.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab4_1_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_06.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab4_1_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_03.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab4_2_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_33.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab4_2_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_27.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab4_2_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_28.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab4_3_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_34.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab4_3_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_15.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab4_3_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_30.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab4_4_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_35.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab4_4_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_06.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab4_4_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_14.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                        ...
                        <div class="row justify-content-lg-between">
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab5_1_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_32.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab5_1_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_06.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab5_1_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_03.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab5_2_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_33.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab5_2_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_27.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab5_2_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_28.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab5_3_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_34.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab5_3_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_15.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab5_3_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_30.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab5_4_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_35.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab5_4_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_06.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab5_4_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_14.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                        ...
                        <div class="row justify-content-lg-between">
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab6_1_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_32.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab6_1_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_06.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab6_1_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_03.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab6_2_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_33.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab6_2_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_27.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab6_2_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_28.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab6_3_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_34.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab6_3_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_15.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab6_3_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_30.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="electronic_product_biglistlayout">
                                    <div class="item_image">
                                        <div class="tab-content">
                                            <img id="child_tab6_4_1" class="tab-pane active"
                                                src="{{ asset('assets/user/images/shop/electronic/img_35.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab6_4_2" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_06.png') }}"
                                                alt="image_not_found">
                                            <img id="child_tab6_4_3" class="tab-pane fade"
                                                src="{{ asset('assets/user/images/shop/electronic/img_14.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <ul class="child_items_nav nav d-flex align-items-center justify-content-center"
                            ...
                            <div class="item">
                                <div class="electronic_deals_grid clearfix">
                                    <div class="item_image" data-bg-color="#ecf7f3">
                                        <img src="{{ asset('assets/user/images/shop/electronic/img_36.png') }}"
                                            alt="image_not_found">
                                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 order-first">
                    <div class="featured_products_wrap">
                        ...
                        <div class="mb_50 clearfix">
                            ...
                            <div class="electronic_product_small">
                                <a class="item_image" href="#!">
                                    <img src="{{ asset('assets/user/images/shop/electronic/img_31.png') }}"
                                        alt="image_not_found">
                                </a>
                                <div class="item_content">
                                    <h4 class="item_title">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                    <div class="featured_products_wrap">
                        ...
                        <div class="mb_50 clearfix">
                            <div class="electronic_product_small">
                                <a class="item_image" href="#!">
                                    <img src="{{ asset('assets/user/images/shop/electronic/img_23.png') }}"
                                        alt="image_not_found">
                                </a>
                                <div class="item_content">
                                    <h4 class="item_title">
                            ...
                            <div class="electronic_product_small">
                                <a class="item_image" href="#!">
                                    <img src="{{ asset('assets/user/images/shop/electronic/img_07.png') }}"
                                        alt="image_not_found">
                                </a>
                                <div class="item_content">
                                    <h4 class="item_title">
