...
<head>
    ...
    <link rel="shortcut icon" href="assets/user/images/logo/favourite_icon_01.png">
...
<header class="header_section electronic_header clearfix">
    <div class="header_advertisement">
        <img src="assets/user/images/offer/electronic/img_01.png" alt="image_not_found">
    </div>
                ...
                <div class="col-lg-3">
                    <div class="brand_logo">
                        <a class="brand_link" href="index.html">
                            <img src="assets/user/images/logo/logo_16_1x.png" srcset="assets/user/images/logo/logo_16_2x.png 2x" alt="logo_not_found">
                        </a>
            ...
            <ul class="cart_items_list ul_li_block mb_30 clearfix">
                <li>
                    <div class="item_image">
                        <img src="assets/user/images/cart/img_01.jpg" alt="image_not_found">
                    </div>
            ...
            <div class="user_info">
                ...
                <div class="profile_info clearfix">
                    <div class="user_thumbnail">
                        <img src="assets/user/images/meta/img_01.png" alt="thumbnail_not_found">
                    </div>
                ...
                <ul class="settings_options ul_li_block clearfix">
                    ...
                    <li><a href="{{route('signout')}}"><i class="fal fa-sign-out-alt"></i> Logout</a></li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="slideshow1_slider" data-slick='{"dots": false}'>
                            <div class="item">
                                <div class="electronic_trending_item text-white">
                                    <div class="item_image">
                                        <img src="assets/user/images/shop/electronic/img_37.png" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                ...
                <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                    <ul class="trending_products_list ul_li clearfix">
                        <li>
                            <div class="etp_small_item text-center">
                                <a class="item_image" href="#!">
                                    <img src="assets/user/images/shop/electronic/img_38.png" alt="image_not_found">
                                </a>
                        ...
                        <li>
                            <div class="etp_small_item text-center">
                                <a class="item_image" href="#!">
                                    <img src="assets/user/images/shop/electronic/img_39.png" alt="image_not_found">
                                </a>
                        ...
                        <li>
                            <div class="etp_small_item text-center">
                                <a class="item_image" href="#!">
                                    <img src="assets/user/images/shop/electronic/img_40.png" alt="image_not_found">
                                </a>
                        ...
                        <li>
                            <div class="etp_small_item text-center">
                                <a class="item_image" href="#!">
                                    <img src="assets/user/images/shop/electronic/img_41.png" alt="image_not_found">
                                </a>
            ...
            <div class="row justify-content-lg-between">
                ...
                <div class="col-lg-9 order-last">
                            ...
                            <ul class="electronic_product_columns ul_li has_4columns clearfix">
                                <li>
                                    <div class="electronic_product_item">
                                        ...
                                        <div class="item_image">
                                            <img src="assets/user/images/shop/electronic/img_02.png" alt="image_not_found">
                                        </div>
                                        <div class="item_content">
                                ...
                                <li>
                                    <div class="electronic_product_item">
                                        ...
                                        <div class="item_image">
                                            <img src="assets/user/images/shop/electronic/img_03.png" alt="image_not_found">
                                        </div>
                                        <div class="item_content">
                                            <span class="item_name">Speakers</span>
                                            <h3 class="item_title">
                                ...
                                <li>
                                    <div class="electronic_product_item">
                                        ...
                                        <div class="item_image">
                                            <img src="assets/user/images/shop/electronic/img_04.png" alt="image_not_found">
                                        </div>
                                        <div class="item_content">
                                            <span class="item_name">Speakers</span>
                                            <h3 class="item_title">
                                ...
                                <li>
                                    <div class="electronic_product_item">
                                        ...
                                        <div class="item_image">
                                            <img src="assets/user/images/shop/electronic/img_05.png" alt="image_not_found">
                                        </div>
                                        <div class="item_content">
                                            <span class="item_name">Speakers</span>
                                            <h3 class="item_title">
                                ...
                                <li>
                                    <div class="electronic_product_item">
                                        ...
                                        <div class="item_image">
                                            <img src="assets/user/images/shop/electronic/img_06.png" alt="image_not_found">
                                        </div>
                                        <div class="item_content">
                                            <span class="item_name">Speakers</span>
                                            <h3 class="item_title">
                                ...
                                <li>
                                    <div class="electronic_product_item">
                                        ...
                                        <div class="item_image">
                                            <img src="assets/user/images/shop/electronic/img_07.png" alt="image_not_found">
                                        </div>
                                        <div class="item_content">
                                            <span class="item_name">Speakers</span>
                                            <h3 class="item_title">
                                ...
                                <li>
                                    <div class="electronic_product_item">
                                        ...
                                        <div class="item_image">
                                            <img src="assets/user/images/shop/electronic/img_08.png" alt="image_not_found">
                                        </div>
                                        <div class="item_content">
                                            <span class="item_name">Speakers</span>
                                            <h3 class="item_title">
                                ...
                                <li>
                                    <div class="electronic_product_item">
                                        ...
                                        <div class="item_image">
                                            <img src="assets/user/images/shop/electronic/img_09.png" alt="image_not_found">
                                        </div>
                                        <div class="item_content">
                                            <span class="item_name">Speakers</span>
                                            <h3 class="item_title">
                    ...
                    <div class="advertisement_image">
                        <a href="#!">
                            <img src="assets/user/images/offer/electronic/img_04.jpg" alt="image_not_found">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="footer_widget footer_about">
                        <div class="brand_logo mb_30">
                            <a href="index.html">
                                <img src="assets/user/images/logo/logo_17_1x.png" srcset="assets/user/images/logo/logo_17_2x.png 2x" alt="logo_not_found">
                            </a>
                        </div>
                        <p class="mb_30">
                        ...
                        <div class="row justify-content-lg-between">
                            <div class="col-lg-6 col-md-6">
                                <div class="electronic_product_small">
                                    <a class="item_image" href="#!">
                                        <img src="assets/user/images/shop/electronic/img_27.png" alt="image_not_found">
                                    </a>
                                    <div class="item_content">
                                        <h4 class="item_title">
                                ...
                                <div class="electronic_product_small">
                                    <a class="item_image" href="#!">
                                        <img src="assets/user/images/shop/electronic/img_31.png" alt="image_not_found">
                                    </a>
                                    <div class="item_content">
                                        <h4 class="item_title">
                                            <a href="#!">Red Wireless Headphones Solo</a>
                                ...
                                <div class="electronic_product_small">
                                    <a class="item_image" href="#!">
                                        <img src="assets/user/images/shop/electronic/img_24.png" alt="image_not_found">
                                    </a>
                                    <div class="item_content">
                                        <h4 class="item_title">
                                            <a href="#!">Red Wireless Headphones Solo</a>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="electronic_product_small">
                                    <a class="item_image" href="#!">
                                        <img src="assets/user/images/shop/electronic/img_23.png" alt="image_not_found">
                                    </a>
                                    <div class="item_content">
                                        <h4 class="item_title">
                                            <a href="#!">Red Wireless Headphones Solo</a>
                                ...
                                <div class="electronic_product_small">
                                    <a class="item_image" href="#!">
                                        <img src="assets/user/images/shop/electronic/img_26.png" alt="image_not_found">
                                    </a>
                                    <div class="item_content">
                                        <h4 class="item_title">
                                            <a href="#!">Red Wireless Headphones Solo</a>
