                ...
                <div class="col-lg-3">
                    <div class="brand_logo">
                        <a class="brand_link" href="index.html">
                            <img src="assets/user/images/logo/logo_27_1x.png" srcset="assets/user/images/logo/logo_27_2x.png 2x" alt="logo_not_found">
                        </a>
                                                ...
                                                <li>
                                                    <a href="home_watch.html">
																<span class="item_image">
																	<img src="assets/user/images/home_pages/watch.png" alt="image_not_found">
																</span>
...
<main>
    ...
    <section class="register_section sec_ptb_140 has_overlay parallaxie clearfix" data-background="assets/user/images/backgrounds/bg_22.jpg">
        ...
        <div class="container">
            <div class="reg_form_wrap login_form" data-background="assets/user/images/reg_bg_01.png">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                    <div class="footer_widget df_about_area">
                        <div class="brand_logo mb_30">
                            <a href="index.html">
                                <img src="assets/user/images/logo/logo_28_1x.png" srcset="assets/user/images/logo/logo_28_2x.png 2x" alt="logo_not_found">
                            </a>
                        </div>
                        ...
                        <ul class="ul_li_block">
                            <li>
                                <div class="small_product">
                                    <div class="item_image">
                                        <img src="assets/user/images/shop/minimal/img_10.jpg" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                        <h3 class="item_title">
                            ...
                            <li>
                                <div class="small_product">
                                    <div class="item_image">
                                        <img src="assets/user/images/shop/minimal/img_11.jpg" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                        <h3 class="item_title">
                                            <a class="text-white" href="#!">
                    ...
                    <div class="footer_widget product_list clearfix">
                        ...
                        <ul class="ul_li_block">
                            <li>
                                <div class="small_product">
                                    <div class="item_image">
                                        <img src="assets/user/images/shop/minimal/img_12.jpg" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                        <h3 class="item_title">
                                            <a class="text-white" href="#!">
                            ...
                            <li>
                                <div class="small_product">
                                    <div class="item_image">
                                        <img src="assets/user/images/shop/minimal/img_13.jpg" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                        <h3 class="item_title">
                                            <a class="text-white" href="#!">
