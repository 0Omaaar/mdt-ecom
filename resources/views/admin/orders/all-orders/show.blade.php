                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a
                                        href="{{ route('admin.orders.show', ['id' => $order->id]) }}">Commande</a>
                                </li>
                                                    ...
                                                    <div class="product-img d-flex align-items-center">
                                                        @if ($item->product->dolibarr_id == null)
                                                            <img class="img-fluid mb-1"
                                                                src="{{ asset('images/products/' . $item->product->id . '/' . $item->product->image) }}"
                                                                alt="Card image cap">
                                                        @else
                                                            <img class="img-fluid mb-1"
                                                                src="{{ asset('productsDolibarr/' . $item->product->dolibarr_id . '/' . $item->product->image) }}"
                                                                alt="Card image cap">
                                                        @endif
                                                    </div>
                                                    <h4 class="product-title">
                                                        {{ Str::limit($item->product->name, 50, '...') }}</h4>
                                ...
                                <div class="categories-list">
                                    ...
                                    <div class="product-cat" id="categories">
                                            ...
                                            <li><span>Type Utilisateur</span>
                                                <ul>
                                                    <li style="font-weight: bold">
                                                        <span>{{ $order->user_id ? 'Client' : 'Session' }}</span>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                                        <ul>
                                            ...
                                            <li>Statut Commande : <span class="badge"
                                                    style="text-transform: uppercase;"><strong>{{ $order->status }}</strong></span>
                                            </li>
                                            <li>Statut Payment : <span class="badge"
                                                    style="text-transform: uppercase;"><strong>{{ $order->payment_status }}</strong></span>
                                            </li>
                                            <li>Methode Livraison: <span class="badge"
                                                    style="text-transform: uppercase;"><strong>{{ $order->shipping_method }}</strong></span>
                                            </li>
                                            <li>Methode Payment: <span class="badge"
                                                    style="text-transform: uppercase;"><strong>{{ $order->payment_method }}</strong></span>
                                            </li>
