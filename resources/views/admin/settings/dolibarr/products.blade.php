        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Liste Produits depuis Dolibarr</h3>
                                            ...
                                            <tbody>
                                                @foreach ($products as $product)
                                                    <tr>
                                                        ...
                                                        <td>{{ Str::limit($product['array_options']['options_web_name'] ?? $product['label'], 15, '...') }}
                                                        </td>

                                                        <td>{{ $product['array_options']['options_web_sku'] ?? 'N/A' }}
                                                        </td>
                                                        <td>{{ $product['array_options']['options_web_price'] ?? '0.00' }} €</td>
                                                        <td>
                                                            {{ $product['array_options']['options_web_stock_status'] == '1' ? 'En stock' : 'Hors stock' }}
                                                        </td>
                                                        <td>{{ $product['array_options']['options_web_category_id'] ?? 'N/A' }}</td>
                                                        <td>{{ Str::limit($product['array_options']['options_web_subcategory_id'] ?? 'N/A', 10, '...') }}</td>
                                                        <td>
                                                            <span class="dropdown">
                                                                ...
                                                                <span aria-labelledby="btnSearchDrop2"
                                                                    ...
                                                                    <a href="{{ route('dolibarr.products.details', $product['id']) }}"
