             ...
             <div>
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body" style="text-align: center">
                            <img src="{{ asset('assets/user/images/offer/electronic/img_02.jpg') }}" width="40%" height="40%">
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header text-center text-white" style="background: rgb(218, 218, 218)">
                        <h4>Nouvelle Offre 1</h4>
                    </div>
                    <div class="card-content p-3">
                        <p class="text-muted text-center mb-3">La taille doit être : <strong>403 x 323</strong></p>
                        <form method="POST" enctype="multipart/form-data" action="#" class="text-center">
                            @csrf
                            <input type="file" id="offre1" name="offre1" required class="form-control-file mb-3" accept="image/*">
                        </form>
                    </div>
                </div>
...
@section('script')
    ...
    <script>
        ...
        // Offre1
        const offre1Input  = document.querySelector('#offre1');
        const offre1Pond = FilePond.create(offre1Input);
        offre1Pond.setOptions({
            server: {
                process: '{{ route('offre1.upload') }}',
                revert: '{{ route('offre1.delete') }}',
                headers: {
