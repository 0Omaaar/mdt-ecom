                    ...
                    <table id="new-orders-table" class="table table-hover table-xl mb-0">
                        ...
                        <tbody>
                            @foreach ($mostOrderedProducts as $product)
                                @php
                                    $productTotal = $product->price * $product->order_count;
                                @endphp
                                <tr>
                                        ...
                                        <ul class="list-unstyled users-list m-0">
                                            @foreach ($product->customers as $customer)
                                                <li data-toggle="tooltip" data-popup="tooltip-custom" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle" src="{{ asset('assets/admin/images/portrait/small/avatar-s-' . rand(1, 20) . '.png') }}" alt="Avatar">
                                                </li>
                                            @endforeach
                                            @if (count($product->customers) > 3)
                                                <li class="avatar avatar-sm">
                                                    <span class="badge badge-info">+{{ count($product->customers) - 3 }} more</span>
                                                </li>
                                            @endif
                                        </ul>
                                    </td>
                                    <td class="text-truncate">${{ number_format($productTotal, 2) }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                                ...
                                <div class="heading-elements">
                                    <ul class="list-inline mb-0">
                                        <li><a class="btn btn-sm btn-danger box-shadow-2 round btn-min-width pull-right"
                                                href="#" target="_blank">Voir Plus de Détails</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card-content">
