                                ...
                                <li>
                                    <button type="button" class="cart_btn">
                                        ...
                                        <span class="btn_badge"
                                            style="background-color: #0063D1">@yield('itemsCount')</span>
                                    </button>
                                </li>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="footer_widget footer_about">
                            <div class="brand_logo mb_30">
                                <a href="{{ route('home') }}">
                                    <img src="{{ asset('assets/user/images/logo/logo_16_2x.png') }}"
                                        srcset="{{ asset('assets/user/images/logo/logo_16_2x.png') }} 2x"
                                        alt="logo_introuvable">
                                </a>
                            </div>
                            <p class="mb_30">
                                Mobidigitech.com est une entreprise dynamique spécialisée dans les produits IT, le
                                développement de sites web, la gestion des médias sociaux, le marketing numérique, ainsi
                                que la réparation d’appareils électroniques. Nous sommes fiers de fournir à nos clients
                                des solutions technologiques complètes et de haute qualité.
                            </p>
                            ...
                            <ul class="circle_social_links ul_li clearfix">
                                <li><a href="https://www.facebook.com/mobidigitech"><i
                                            class="fab fa-facebook-f"></i></a></li>
                                <li><a href="https://www.instagram.com/mobidigitech"><i
                                        ...
                                        @if ($index % 2 == 0)
                                            <div class="electronic_product_small">
                                                ...
                                                <div class="item_content">
                                                    <h4 class="item_title">
                                                        <a
                                                            href="{{ route('product', $product->id) }}">{{ Str::limit($product->name, 14, '...') }}</a>
                                                    </h4>
